...
import { AsyncRequestHandler, ICommunicator, IRoutePattern } from "http-express.remoting";
import { ICommunicatorConstructorOptions, ChannelType } from "http-express.ipc";
