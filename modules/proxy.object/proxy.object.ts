...
import { IDisposable, IDictionary } from "http-express.common";
import { ICommunicator, AsyncRequestHandler, IRoutePattern } from "http-express.remoting";
import { IObjectRemotingProxy, Resolver } from "http-express.proxy.object";
