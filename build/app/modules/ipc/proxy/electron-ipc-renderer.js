...
class ElectronIpcRendererChannelProxy extends channel_proxy_base_1.default {
    constructor(channel, channelName, windowId) {
        super(channel);
        ...
        this.channelName = channelName || uuidv5(electron.remote.getCurrentWebContents().id.toString(), common_1.UuidNamespace);
...
exports.default = ElectronIpcRendererChannelProxy;
//# sourceMappingURL=electron-ipc-renderer.js.map